...
import { Chart, registerables  ,plugins} from 'chart.js/auto'
...
function Stradle2(){
  ...
  useEffect(() => {
    ...
    chartRef.current = new Chart(canvasRef.current, config);                // this is the where i defint the chart idiot chart
    chartRef.current.canvas.parentNode.style.height = '400px';
    chartRef.current.canvas.parentNode.style.width = '1200px' 
  ...
  return (
    <div>
      <div className="selectdrop">
        <h1 className = 'custom'>hello this is not working </h1>
      <select className='optionselect' id = 'optionselect' value={select1} onChange={handleselect1}>
      ...
      <select className='optionselect' id="expiryselect" value={select2} onChange={handleselect2}>
